...
- Run `python3 scripts/fetch_market_data.py {TICKER} {DATE} 30` to get stock prices and technical indicators
- If the script is unavailable, search for the latest market data
